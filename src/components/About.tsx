...
const About = () => {
  return (
    <section id="about" className="py-10 px-0 md:px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="pb-10 font-mono text-center brightness-125 text-arch-primary">
          for ye = &#123; !gods &#125;<br />
          Psalms({"{82, 6}"});
        </div>
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            About{" "}
            <span className="text-transparent bg-gradient-arch bg-clip-text">
              Me
            </span>
          </h2>
          ...
          <div className="space-y-6">
            <Card className="space-card p-8 hover-lift">
              ...
              <p className="text-structure-primary leading-relaxed">
                I design and build exceptional digital experiences that bridge
                the gap between innovative design and robust functionality. With
                a passion for clean code and user-centric interfaces, I
            ...
            <Card className="space-card p-8 hover-lift">
              ...
              <p className="text-structure-primary leading-relaxed">
                Specializing in modern web technologies, I create scalable
                applications with attention to performance, accessibility, and
                maintainability. Every line of code is written with purpose and
                precision.
              </p>
            </Card>
          </div>
                ...
                {[
                  ...
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between text-structure-primary">
                      ...
                      <span className="font-mono text-arch-primary">
                        {item.value}
                      </span>
                    </div>
