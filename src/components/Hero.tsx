...
import heroPic from "@/assets/nebula-hero-bg.png";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div
          className="absolute bottom-40 right-20 w-3 h-3 bg-cosmic-primary rounded-full animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-40 right-10 w-1 h-1 bg-arch-secondary rounded-full animate-float"
